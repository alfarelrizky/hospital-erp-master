<?php defined('BASEPATH') OR exit('No direct script access allowed'); ?><!DOCTYPE html>
  ...
  <body>
      <div id="container">
           <div id="body">
                 <h1>Data Pasien RS Sentosa Jaya </h1>
                ...
                <?php include "form_cari.php"; ?>
                 ...
                 <?php foreach ($data_pasien as $row) { ?>
                      <tr align=center>
                           ...
                           <td>
<a href="<?php echo base_url()?>pasien/edit_pasien/<?php echo $row['id_pasien']; ?>"> Edit Data</a>                               
<a href="<?php echo base_url()?>rekam_medis/detil_rm/<?php echo $row['id_pasien']; ?>"> Detil RM</a> 
                           </td>
                      </tr>
                 <?php } ?>
            </table>
